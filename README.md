...
**ΠΡΟΣΟΧΗ -  Αν ο διαχειριστής σβήσει την επαφή, το Viber πιθανά να σβήσει και την εφαρμογή από το περιβάλλον του, μιας δεν εμφανίζεται ποια κανένας administator για την εφαρμογή
